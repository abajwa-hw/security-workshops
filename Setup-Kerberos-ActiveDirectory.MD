...
- To setup the Ranger Knox plugin and do audit exercises for WebHDFS/Hive over Knox, you can follow the [usual guide](https://github.com/abajwa-hw/security-workshops/blob/master/Setup-knox-23.md) 
