...
- Now run through the audit exercises for WebHDFS/Hive over Knox (plus Ranger plugin setup), you can follow the [usual guide](https://github.com/abajwa-hw/security-workshops/blob/master/Setup-knox-23.md) 
